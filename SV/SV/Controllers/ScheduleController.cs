...
namespace SV.Controllers
{
    public class ScheduleController : Controller
    {
        ...
        public ActionResult DsLop(RankEnum rank, SessionEnum sessionType)
        {
            ...
            var Lops = DbContext.Lops.Where(m => LopIds.Contains(m.Id) && !m.IsDelete)
        ...
        public ActionResult DsStudent(int lopId, RankEnum rank, SessionEnum sessionType)
        {
            ...
            var Schedules = DbContext.Schedules.Where(m => m.LopId == lopId && m.Rank == rank && m.Session == sessionType)
